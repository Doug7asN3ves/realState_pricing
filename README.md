...
### Foi criado modelo para previsão dos preços imobiliários, o modelo foi salvo em um arquivo pickle e é possível ser rodado através de uma API construída.

### Os arquivos finais estão localizados na pasta "Source" e prontos para execução

### Para construção do modelo foram feitas análises exploratórias e considerações que podem ser melhor vistas dentro da pasta de "Análises", dentro do notebook com nome do projeto
